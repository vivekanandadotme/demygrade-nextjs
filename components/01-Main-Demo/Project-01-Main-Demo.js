...
import About from "@/components/Abouts/Project-About";
import ServiceSaven from "@/components/Services/Project-Service-Saven";
import CardFour from "@/components/Cards/Project-Card-Four";
import CategoryThreeSlider from "@/components/Category/Project-CategoryThreeSlider";
import BrandOne from "@/components/Brand/Project-Brand-Three";
import TestimonialTwo from "@/components/Testimonials/Project-Testimonial-Two";
const MainDemo = () => {
  return (
    <>
